...
def render_catalog_view():
    ...
    # Clean column names mapping (adjust based on your actual sheet column names)
    ...
    with st.expander("🔎 Filters", expanded=True):
        ...
        brand_filter = st.selectbox("Select Brand", ["All"] + sorted(df["Brand"].unique().tolist()))
        category_filter = st.selectbox("Select Category", ["All"] + sorted(df["Category"].unique().tolist()))
